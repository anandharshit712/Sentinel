...
_Worked check (Demo Run 2):_ 1 Critical SQLi finding (+40) + auth sensitive-area flag (+15) + all tests green (0) = **55 (high)** minimum — gating on `test→qa` or higher escalates, even though CI is green. Binary gating structurally cannot do this.
