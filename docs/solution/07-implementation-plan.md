...
| #   | Task                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
| --- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 0.1 | Repo scaffold exactly per [04 §1](04-lld.md): `registries/`, `coded_tools/delivery_intelligence/`, `config/`, `gateway/`, `frontend/`, `samples/`, `deploy/`, `tests/`. Python 3.12+, `neuro-san==0.6.70` line pinned, pre-commit lint.                                                                                                                                                                                                                                                                                                                                                                                         |
...
| 1.2 | `gateway/db/migrations/` — Alembic baseline with full DDL ([04 §8](04-lld.md))                                                                                                                                                                                                            | Migration applies clean on compose Postgres                          |
| 1.3 | `lib/dao.py` — thin SQLAlchemy DAO shared by coded tools & Gateway                                                                                                                                                                                                                        | CRUD smoke tests per table                                           |
...
`registries/delivery_intelligence.hocon` grows slice by slice; each slice is a runnable network verified with NSFlow interactively + a data-driven fixture test ([04 §11](04-lld.md)). Real NIM calls; sample-repo events.
