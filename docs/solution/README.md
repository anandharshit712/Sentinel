...
| 04  | [Low-Level Design](04-lld.md)                       | Project layout, full agent-network HOCON, JSON contracts, all 19 coded tools, LLM config (NVIDIA NIM), Gateway API + CI/CD adapters, PostgreSQL DDL, dashboard, deployment artifacts, testing, error handling. |
